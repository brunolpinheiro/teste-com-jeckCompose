package com.example.gest.bluetooth.model
...
import com.example.gest.bluetooth.utils.PermissionHelper
import com.example.gest.bluetooth.manager.BluetoothPrinterManager
    ...
    fun printLabel(
        ...
        viewModelScope.launch {
            try {
                ...
                builder.appendLine("! 0 200 200 315 $text5")
                builder.appendLine("PAGE-WIDTH 350")
                builder.appendLine("SETFF 0")
                //builder.appendLine("SETMAG 2 2") // dobra largura e altura
                var y = 30
                builder.appendLine("""TEXT 4 0 10 $y $text1""")
                y += 40
               // builder.appendLine("SETMAG 1 1") // volta ao normal
                ...
                listOf(
                    ...
                    builder.appendLine("""TEXT 2 0 20 $y $line""")
                    y += 30
                }
                y += 5
                builder.appendLine("""LINE 10 $y 350 $y 2""")
                y += 10
                builder.appendLine("SETBOLD 3")  // valor 1–9 (quanto maior, mais grosso)
                builder.appendLine("""TEXT 4 0 280 $y Gest """)
                builder.appendLine("SETBOLD 0")  // volta ao normal
